...
const url = 'https://whatisaw.firebaseapp.com/post/';
const site_name = 'WhatISaw';
const title = 'WhatISaw';
const meta_description = '見たモノ・ヒト・コトを記録する。';
const meta_keywords = ['WhatISaw'];
const og_description = '見たモノ・ヒト・コトを記録する。';
const og_image_width = 1200;
const og_image_height = 630;
const fb_appid = '';
const tw_description = '見たモノ・ヒト・コトを記録する。';
const tw_site = 'https://whatisaw.firebaseapp.com/post/';
const tw_creator = '';
